...
file = os.path.join(base_path,r"C:\Users\Kowshik\PycharmProjects\resume-job-recommendation-systemss\resume_screening\LINKEDIN_SKILLS_ORIGINAL.txt")
...
data = read_file( r'instance/resume_files/KOWSHIK.pdf' )
